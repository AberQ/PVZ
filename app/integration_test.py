...
if response_login.status_code != 200:
    ...
    if response_pvz.status_code != 201:
        ...
        response_login_employee = requests.post(
            url_login, json=data_login_employee, headers=headers_login_employee
        )
        ...
        if response_login_employee.status_code != 200:
            ...
            if response_pvz_get.status_code != 200:
                ...
                if not pvz_id:
                    ...
                    response_receptions = requests.post(
                        url_receptions, json=data_receptions, headers=headers_receptions
                    )
                    if response_receptions.status_code != 201:
                        ...
                        success_count = 0
                        for _ in range(50):
                            data_products = {"type": "электроника", "pvzId": pvz_id}
                        ...
                        if success_count == 50:
                            ...
                            response_close = requests.post(
                                url_close_reception, headers=headers_close
                            )
